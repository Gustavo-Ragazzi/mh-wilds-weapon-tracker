...
class TrackerUI:
  def __init__(self, tracker: WeaponTracker):
    ...
    self.title_label = tk.Label(self.root, text="Weapon Usage Tracker", font=("Segoe UI", 16, "bold"), fg="white", bg="#2e2e2e")
    ...
    self.next_label = tk.Label(self.root, text="", font=("Segoe UI", 13), fg="white", bg="#2e2e2e", justify="left")
